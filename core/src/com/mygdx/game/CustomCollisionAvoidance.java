 ...
 *
 * @author davebaol */
public class CustomCollisionAvoidance<T extends Vector<T>> extends GroupBehavior<T> implements ProximityCallback<T> {
    ...
    @Override
    public CustomCollisionAvoidance<T> setOwner (Steerable<T> owner) {
        this.owner = owner;
        return this;
    }

    @Override
    public CustomCollisionAvoidance<T> setEnabled (boolean enabled) {
    ...
    @Override
    public CustomCollisionAvoidance<T> setLimiter (Limiter limiter) {
