 ...
 *
 * @author davebaol */
public class CustomSeperation<T extends Vector<T>> extends GroupBehavior<T> implements ProximityCallback<T> {
    ...
    public CustomSeperation<T> setDecayCoefficient (float decayCoefficient) {
    ...
    @Override
    public CustomSeperation<T> setOwner (Steerable<T> owner) {
        this.owner = owner;
        return this;
    }

    @Override
    public CustomSeperation<T> setEnabled (boolean enabled) {
    ...
    @Override
    public CustomSeperation<T> setLimiter (Limiter limiter) {
